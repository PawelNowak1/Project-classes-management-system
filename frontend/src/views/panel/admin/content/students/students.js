...
import EditStudent from '../students/modals/editStudent';
...
function Students(props) {
    ...
    return (
        <>
                ...
                <ContentBody>
                    <FiltersWrapper>
                        <div>
                            ...
                            />
                            <Search
                                placeHolder={'Imię / Nazwisko / Numer studenta'}
                                value={search}
                                onChange={(e) => setSearch(e.target.value)}
                            />
                        </div>
                        <div>
                            <Link to="/panel/students/add-student">
                                <Button>
                    ...
                    <ContentTable cellspacing="0" cellpadding="0">
                        ...
                        {students.map((student) => (
                            <tr>
                                ...
                                <td>
                                    <Link to="/panel/students/edit-student">
                                        <FontAwesomeIcon
                                            icon={faPen}
            ...
            />
            <Route
                path="/panel/students/edit-student"
                component={() => (
                    <EditStudent
                        refresh={refresh}
                        setRefresh={setRefresh}
